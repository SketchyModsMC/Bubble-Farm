...
bubbleImage.src = 'bubble_image.png'
class Bubbles {
    constructor() {
...
enemyImage.src = 'pink_fish_enemy.png';
...
class Enemy {
    ...
    draw() {
        ...
        ctx.arc(this.x, this.y, this.radius, 0, Math.PI * 2);
        ctx.fill();*/
        ctx.drawImage(enemyImage, this.frameX * this.spriteWidth, this.frameY * this.spriteHeight, this.spriteWidth, this.spriteHeight, this.x - 60, this.y - 70,
